...
$past_pays_2 = countPastPaysAT2($thisY, $thisM, $LOGIN_ID);
...
foreach ($accss as $ad) {
    ...
    if ($ad->adware_type=="0") {
        $adHtml .= '<p class="label"><span class="bg_pink">成果報酬</span>';
    } else {
      ...
      <div class="section__inner container">
        <div class="result__table_wrap">
          <div class="tab-style_table_area">
            ...
            <td class="td-num"><?php echo(number_format($past_pays_0->cnt + $past_pays_1->cnt + $past_pays_2->cnt0)); ?>件</td>
            <td class="td-num"><?php echo(number_format($past_pays_0->cnt2 + $past_pays_1->cnt2 + $past_pays_2->cnt3)); ?>件</td>
            <td class="td-num"><?php echo(number_format($past_pays_0->cst0 + $past_pays_1->cst0 + $past_pays_2->cst2)); ?>円</td>
