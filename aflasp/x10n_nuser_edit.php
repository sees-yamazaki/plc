...
<body>
    ...
    <form action="" method="POST">
        ...
        <input type="text" name="mail"
            value="<?php echo $nUser->mail;?>" size="50"
            maxlength="128"><br>
        <br>
        メールアドレス(再入力)<br>
        <input type="text" name="mail_confirm"
            value="<?php echo $nUser->mail_confirm;?>" size="50"
            maxlength="128"><br>
        <br>
        パスワード<br>
        ...
        <input type="text" name="name"
            value="<?php echo $nUser->name;?>" size="25"
            maxlength="32"><br>
        <br>
        <br>
        現住所<br>
        ...
        <input type="text" name="tel"
            value="<?php echo $nUser->tel;?>" size="15"
            maxlength="15"><br>
        <br>
        FAX番号<br>
        <input type="text" name="fax"
            value="<?php echo $nUser->fax;?>" size="15"
            maxlength="15"><br>
        <br>
        <br>
        バナー掲載ＵＲＬ<br>
        <input type="text" name="url"
            value="<?php echo $nUser->url;?>" size="80"
            maxlength="256"><br>
        <br><br>
        金融機関名<br>
