...
<body>
    ...
    <form action="staffInfo7.php" method="POST">
        ...
        <tr>
                ...
                <td><input type="text" id="emergency_kana" name="emergency_kana" class="txtS" maxlength=30 style="ime-mode: active;" pattern="[ァ-ヴー\s　]+" title="カタカナ" placeholder="全角カタカナ" onblur="harf2wide(this);"  value="<?php echo $emergency_kana; ?>"></td>
            </tr>
            <tr>
                <th>連絡人<span class="fnt1em"> (30)</span></th>
                <td><input type="text" id="emergency" name="emergency" class="txtS" maxlength=30 style="ime-mode: active;"  value="<?php echo $emergency; ?>"></td>
            </tr>
            <tr>
                <th>郵便番号<span class="fnt1em"> (8)</span></th>
                <td><input type="text" id="post2" name="post2" class="txtS" maxlength=8 style="ime-mode:disabled" placeholder="123-4567" pattern="\d{3}-?\d{4}" title="郵便番号"  value="<?php echo $post2; ?>"></td>
            </tr>
            <tr>
                <th>現住所<span class="fnt1em"> (100)</span></th>
                <td><input type="text" id="address2" name="address2" class="txtS" maxlength=100 style="ime-mode: active;"  value="<?php echo $address2; ?>"></td>
            </tr>
            <tr>
                <th>固定回線<span class="fnt1em"> (13)</span></th>
                <td><input type="tel" id="tel10" name="tel10" class="txtS" maxlength=13 style="ime-mode:disabled" placeholder="090-1234-5678" pattern="\d{2,4}-?\d{3,4}-?\d{3,4}"  value="<?php echo $tel10; ?>"></td>
            </tr>
            <tr>
                <th>携帯電話<span class="fnt1em"> (13)</span></th>
                <td><input type="tel" id="tel11" name="tel11" class="txtS" maxlength=13 style="ime-mode:disabled" placeholder="090-1234-5678" pattern="\d{2,4}-?\d{3,4}-?\d{3,4}"  value="<?php echo $tel11; ?>"></td>
            </tr>
            <tr>
                <th>指定連絡先</th>
                <td>
