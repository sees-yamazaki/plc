    ...
    if (!empty($_SESSION["LEVEL"])) {
        ...
        try {
            ...
            while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                ...
                $html .= '<tr><form id="useredit" action="jobEdit.php" method="POST">';
                $html .= "<input type='hidden' name='jSeq' value='".$row["job_seq"]."'>";
                $html .= "<td width='100px'>".$row['job_id']."</td>";
...
<body>
    ...
    <table class="vw2" width="60%">
        <tr>
            <th>案件ID</th>
            <th>案件名</th>
            <th class="add" width="130px">
                <div style="vertical-align:middle;"><button type='button'
                        onclick="location.href='jobEdit.php'">新規登録</button>
            </th>
